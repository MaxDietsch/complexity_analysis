...
from ICNet_bigger import ICNet
...
if __name__ == "__main__":
    ...
    model = ICNet(args.image_size, args.image_size // 2, 128) 
    ...
    torch.save(model.state_dict(), os.path.join(args.ck_save_dir,'ck_bigger{}_bs{}_is{}_lr{}.pth'.format(epoch, args.batch_size, args.image_size, args.lr)))
